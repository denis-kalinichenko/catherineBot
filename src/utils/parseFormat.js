module.exports = function (moment) {
    ...
    var abbreviatedDayNames = moment.weekdaysShort()
    var shortestDayNames = moment.weekdaysMin()
    ...
    var regexMonthNames = new RegExp(moment.localeData().monthsRegex(true).source.replace("^", ""), "i")
    var regexAbbreviatedMonthNames = new RegExp(moment.localeData().monthsShortRegex(true).source.replace("^", ""), "i")
